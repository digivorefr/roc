...
#
# Produces the PyInstaller --onefile binary at:
...
#
# Run from any directory. Run twice = same behavior (idempotent). The
# build/.venv/ and .pyinstaller-* artefacts are wiped before exit on
# success.
#
